  ...
  implicit class SparkConfHelper(conf: SparkConf) {
    def registerGSPKryoClasses(): SparkConf =
      conf.registerKryoClasses(Array(
        ...
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcIF$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcID$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcJI$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcJJ$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcJF$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcJD$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcFI$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcFJ$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcFF$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcFD$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcDI$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcDJ$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcDF$sp],
        classOf[one.off_by.sequence.mining.gsp.Transaction$mcDD$sp],
        ...
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcIF$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcID$sp]],
        ...
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcJF$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcJD$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcFI$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcFJ$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcFF$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcFD$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcDI$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcDJ$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcDF$sp]],
        classOf[Array[one.off_by.sequence.mining.gsp.Transaction$mcDD$sp]],
        classOf[Element[_]],
